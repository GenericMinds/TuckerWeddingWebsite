...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-18fpzkm"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-18fpzkm"}"><li class="${"home svelte-18fpzkm"}">Home</li>
        <li class="${"svelte-18fpzkm"}">Our Story</li>
        <li class="${"svelte-18fpzkm"}">Our Clan</li>
        <li class="${"svelte-18fpzkm"}">Toasts</li>
        <li class="${"svelte-18fpzkm"}">Propose a Toast</li>
        <li class="${"svelte-18fpzkm"}">Blended Family</li></ul>`,
				default: () => `

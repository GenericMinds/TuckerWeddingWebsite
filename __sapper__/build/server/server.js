...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<img src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-1ylyyc6"}">`;
});
...
const Menu = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${isOpen
	? `<div class="${"menu svelte-1iuog3x"}"><ul class="${"svelte-1iuog3x"}"><li class="${"home svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Home</div></li>
            <li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Our Story</div></li>
            <li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Our Clan</div></li>
            <li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Toasts</div></li>
            <li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Propose a Toast</div></li>
            <li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Blended Family</div></li>
        ${isLoggedIn
		? `<li class="${"svelte-1iuog3x"}"><div class="${"arrow svelte-1iuog3x"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1iuog3x"}"></div>
                <div class="${"section svelte-1iuog3x"}">Log out</div></li>`
		: ``}</ul></div>`
	: ``}`;
});

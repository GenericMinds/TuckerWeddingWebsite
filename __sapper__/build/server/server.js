...
const css = {
	code: "@media only screen \r\n    and (min-width : 320px) \r\n    and (max-width : 450px){img.svelte-1jqnxai{padding-left:35%;padding-right:35%}div.svelte-1jqnxai{height:20px;padding:0;display:flex}}@media only screen \r\n    and (min-width : 451px){img.svelte-1jqnxai{padding-left:35%;padding-right:35%}div.svelte-1jqnxai{height:40px;padding:0;display:flex}}",
	map: "{\"version\":3,\"file\":\"HeadingDecorator.svelte\",\"sources\":[\"HeadingDecorator.svelte\"],\"sourcesContent\":[\"<div>\\r\\n    <img alt='Heading Decoration' src='./HeadingDecorator.png'>\\r\\n</div>\\r\\n<style>\\r\\n\\r\\n@media only screen \\r\\n    and (min-width : 320px) \\r\\n    and (max-width : 450px) {  \\r\\n    img {\\r\\n        padding-left: 35%;\\r\\n        padding-right: 35%;\\r\\n    }\\r\\n    div {\\r\\n        height: 20px;\\r\\n        padding: 0;\\r\\n        display: flex;\\r\\n    }\\r\\n    }\\r\\n    @media only screen \\r\\n    and (min-width : 451px) {\\r\\n            img {\\r\\n        padding-left: 35%;\\r\\n        padding-right: 35%;\\r\\n    }\\r\\n    div {\\r\\n        height: 40px;\\r\\n        padding: 0;\\r\\n        display: flex;\\r\\n    }\\r\\n    }\\r\\n</style>\"],\"names\":[],\"mappings\":\"AAKA,OAAO,IAAI,CAAC,MAAM;IACd,GAAG,CAAC,aAAa,KAAK,CAAC;IACvB,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AACzB,GAAG,eAAC,CAAC,AACD,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,GAAG,eAAC,CAAC,AACD,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,AACjB,CAAC,AACD,CAAC,AACD,OAAO,IAAI,CAAC,MAAM;IAClB,GAAG,CAAC,aAAa,KAAK,CAAC,AAAC,CAAC,AACjB,GAAG,eAAC,CAAC,AACT,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,GAAG,AACtB,CAAC,AACD,GAAG,eAAC,CAAC,AACD,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,AACjB,CAAC,AACD,CAAC\"}"
};

const HeadingDecorator = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `<div class="${"svelte-1jqnxai"}"><img alt="${"Heading Decoration"}" src="${"./HeadingDecorator.png"}" class="${"svelte-1jqnxai"}">
</div>`;
});
...
const css$1 = {
	code: "@media only screen and (min-width: 0px) and (max-width: 450px){.outter.svelte-1q89ybc{background-color:#375637;height:65px;line-height:65px;width:100%;margin-top:20px;padding:0;border-top-left-radius:10px;border-top-right-radius:10px}h1.svelte-1q89ybc{font-size:32px !important;line-height:32px;color:#ddd499;margin:0 !important;padding-top:12px !important}.container.svelte-1q89ybc{position:relative;transform:translateY(-50%);top:50%}}@media only screen and (min-width: 451px){div.svelte-1q89ybc{background-color:#375637;height:120px;line-height:120px;width:100%;margin-top:20px;padding:0;border-top-left-radius:10px;border-top-right-radius:10px}h1.svelte-1q89ybc{font-size:70px !important;line-height:70px;padding-top:12px !important;color:#ddd499;margin:0 !important}}",
	map: "{\"version\":3,\"file\":\"SectionHeader.svelte\",\"sources\":[\"SectionHeader.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import HeadingDecorator from './HeadingDecorator.svelte';\\r\\nexport let title;\\r\\n</script>\\r\\n\\r\\n<div class='outter'>\\r\\n    <div class='container'>\\r\\n    <h1>{title}</h1>\\r\\n    <HeadingDecorator />\\r\\n    </div>\\r\\n</div>\\r\\n<style lang='scss'>@media only screen and (min-width: 0px) and (max-width: 450px) {\\n  .outter {\\n    background-color: #375637;\\n    height: 65px;\\n    line-height: 65px;\\n    width: 100%;\\n    margin-top: 20px;\\n    padding: 0;\\n    border-top-left-radius: 10px;\\n    border-top-right-radius: 10px; }\\n  h1 {\\n    font-size: 32px !important;\\n    line-height: 32px;\\n    color: #ddd499;\\n    margin: 0 !important;\\n    padding-top: 12px !important; }\\n  .container {\\n    position: relative;\\n    transform: translateY(-50%);\\n    top: 50%; } }\\n\\n@media only screen and (min-width: 451px) {\\n  div {\\n    background-color: #375637;\\n    height: 120px;\\n    line-height: 120px;\\n    width: 100%;\\n    margin-top: 20px;\\n    padding: 0;\\n    border-top-left-radius: 10px;\\n    border-top-right-radius: 10px; }\\n  h1 {\\n    font-size: 70px !important;\\n    line-height: 70px;\\n    padding-top: 12px !important;\\n    color: #ddd499;\\n    margin: 0 !important; } }</style>\"],\"names\":[],\"mappings\":\"AAUmB,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,GAAG,CAAC,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACjF,OAAO,eAAC,CAAC,AACP,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CACV,sBAAsB,CAAE,IAAI,CAC5B,uBAAuB,CAAE,IAAI,AAAE,CAAC,AAClC,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CAAC,UAAU,CAC1B,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,CAAC,CAAC,UAAU,CACpB,WAAW,CAAE,IAAI,CAAC,UAAU,AAAE,CAAC,AACjC,UAAU,eAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,WAAW,IAAI,CAAC,CAC3B,GAAG,CAAE,GAAG,AAAE,CAAC,AAAC,CAAC,AAEjB,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,GAAG,eAAC,CAAC,AACH,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,KAAK,CACb,WAAW,CAAE,KAAK,CAClB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CACV,sBAAsB,CAAE,IAAI,CAC5B,uBAAuB,CAAE,IAAI,AAAE,CAAC,AAClC,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CAAC,UAAU,CAC1B,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CAAC,UAAU,CAC5B,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,CAAC,CAAC,UAAU,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const SectionHeader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"outter svelte-1q89ybc"}"><div class="${"container svelte-1q89ybc"}"><h1 class="${"svelte-1q89ybc"}">${escape(title)}</h1>
    ${validate_component(HeadingDecorator, "HeadingDecorator").$$render($$result, {}, {}, {})}</div>
</div>`;
});
...
const Story = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"svelte-1mx9tk9"}"><p class="${"svelte-1mx9tk9"}"><span class="${"svelte-1mx9tk9"}">Once upon a time...</span> there was a king and a viking princess. They did not know it, but the gods had set the table for them to be together.</p>
        <p class="${"svelte-1mx9tk9"}">As the gods planned out their destiny, they couldn&#39;t quite agree on the path these two should take to get there. One of the gods set up their first meeting. As they were both looking to learn more about the world around them, they attended the Academy at the same time. The first god set it up so that they lived in close proximity. Once the other gods noticed, they intervened and kept them from meeting each other. It was not their time yet.</p>
        <p class="${"svelte-1mx9tk9"}">Both the king and the viking princess went on to have families of their own. Another one of the gods thought that this was the time and moved them to the same town. Both of their families grew up at the same time. The king had two daughters and the viking princess had two sons and two daughters. The kids grew up with each other and became friends. The eldest viking son and the eldest princess of the king both pursued the bardic arts together. The youngest viking daughter and the youngest princess of the king battled for the raiders through volley after volley of balls flung by the invading armies. Through all of this the other gods decided it was not time for the king and the viking princess to meet, and kept them apart. It was not their time yet.</p>
        <p class="${"svelte-1mx9tk9"}">A third god decided to make his move and arranged it so the viking princess joined the Parent Teacher Student Guild along with the Queen. Both were valiant champions in making sure the children of the kingdom were getting the appropriate education. Throughout their many meetings and public events, the other gods decided to intervene and not allow the king and viking princess to cross paths. It was not their time yet.</p>
        <p class="${"svelte-1mx9tk9"}">The viking princess pursued her advancement in the Parent Teacher Student Guild with fervor and eventually reached the rank of Teacher of The Native Tongue. A fourth god decided this would be the perfect time to introduce the king and the viking princess. This god arranged for the king&#39;s youngest princess to become an apprentice of the viking princess. Alas, the other gods intervened yet again and did not let their paths cross. It was not their time yet.</p>
        <p class="${"svelte-1mx9tk9"}">Living within the same kingdom, they were often in the market at the same time. Neither taking notice of each other. The gods had again decided to keep them away from each other. It was not their time yet.</p>
        <p class="${"svelte-1mx9tk9"}">By this point in time, both had moved on from their previous relationships. While there were times where they were happy, they knew deep down that something was missing. Their sons and daughters had grown up and had families of their own. The gods finally decided it was time.</p>
        <p class="${"svelte-1mx9tk9"}">One fateful day, they aligned the stars to allow them to meet. The king was discussing life with a noble friend of his in the market when the viking princess entered. Their paths would have crossed yet again without interaction, but the gods had carefully laid out this moment. The noble that the king was talking to happened to also be the brother in law of the eldest viking daughter. The noble noticed the viking princess and decided to make an introduction. After the noble left, they continued their shopping, glancing at each other through the market stalls. The strands of fate spinning stronger and stronger with each passing. Humans tend to be unpredictable and resist their destinies. The viking princess abruptly left the market without talking with the king further.</p>
        <p class="${"svelte-1mx9tk9"}">The gods didn&#39;t like this. They filled her head with doubt and her heart with excitement. She knew she veered from their plans and decided to take her shot. She sent out messengers to find the king. They eventually tracked him down and arranged for them to meet again. A quick meeting at the tavern turned into a long conversations leading into the dead of night, yet somehow time felt like it was standing still. Everything was falling into place and the match felt like a perfect fit. But as a human himself, the king was stubborn and decided he wasn&#39;t ready for his destiny.</p>
...
const Blended = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"svelte-1nv4900"}"><p class="${"svelte-1nv4900"}">Put a good and honest man</p>
        <p class="${"svelte-1nv4900"}">into a mixing pan.</p>
        <p class="${"svelte-1nv4900"}">Combine one loving woman</p>
        <p class="${"svelte-1nv4900"}">and blend well with the man.</p>
        <br>
        <p class="${"svelte-1nv4900"}">Add the children of the man,</p>
        <p class="${"svelte-1nv4900"}">and the woman&#39;s children too.</p>
        <p class="${"svelte-1nv4900"}">Mix them all together</p>
        <p class="${"svelte-1nv4900"}">as you would a pot of stew.</p>
        <br>
        <p class="${"svelte-1nv4900"}">Slowly stir in patience.</p>
        <p class="${"svelte-1nv4900"}">It will really help a lot.</p>
        <p class="${"svelte-1nv4900"}">If you&#39;re not sure how much,</p>
        <p class="${"svelte-1nv4900"}">throw in all you&#39;ve got.</p>
        <br>
        <p class="${"svelte-1nv4900"}">Then, six cups of sweetener</p>
        <p class="${"svelte-1nv4900"}">and fourteen cups of love.</p>
        <p class="${"svelte-1nv4900"}">Sprinkle in some blessings</p>
        <p class="${"svelte-1nv4900"}">from the heavens high above.</p>
        <br>
        <p class="${"svelte-1nv4900"}">When the mixture is complete,</p>
        <p class="${"svelte-1nv4900"}">with great joy you will see...</p>
        <p class="${"svelte-1nv4900"}">creation of our awesome,</p>
        <p class="${"svelte-1nv4900"}">loving blended family.</p></div>
</section>`;
});
...
const Clan = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"wrapper2 svelte-2o008v"}"><div class="${"demo svelte-2o008v"}">${each(carousels, carousel => `${validate_component(Carousel, "Carousel").$$render($$result, Object.assign(carousel), {}, {
		"left-control": () => `<span class="${"control left svelte-2o008v"}" slot="${"left-control"}">${validate_component(ChevronLeftIcon, "ChevronLeftIcon").$$render($$result, {}, {}, {})}</span>`,
		"right-control": () => `<span class="${"control right svelte-2o008v"}" slot="${"right-control"}">${validate_component(ChevronRightIcon, "ChevronRightIcon").$$render($$result, {}, {}, {})}
            </span>`,
		default: () => `
            ${each(photos, photo => `<div class="${"slide-content svelte-2o008v"}"><img${add_attribute("src", photo, 0)} alt="${"pic"}" class="${"svelte-2o008v"}">
            </div>`)}
            `
	})}
        <br>
...
const ToastForm = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"propose svelte-1f7z7gp"}">${validate_component(SectionHeader, "SectionHeader").$$render(
		$$result,
		{
    ...
    <div class="${"svelte-1f7z7gp"}"><input class="${"form-element svelte-1f7z7gp"}" type="${"text"}" ${!isLoggedIn ? "disabled" : ""} placeholder="${"Name"}"${add_attribute("value", toast.toasterName, 1)}>
            <select class="${"form-element svelte-1f7z7gp"}" ${!isLoggedIn ? "disabled" : ""}${add_attribute("value", toast.toasterRelationship, 1)}><option selected disabled hidden value="${"Select Relationship"}" class="${"svelte-1f7z7gp"}">Select Relationship</option><option value="${"Father"}" class="${"svelte-1f7z7gp"}">Father</option><option value="${"Mother"}" class="${"svelte-1f7z7gp"}">Mother</option><option value="${"Brother"}" class="${"svelte-1f7z7gp"}">Brother</option><option value="${"Sister"}" class="${"svelte-1f7z7gp"}">Sister</option><option value="${"Son"}" class="${"svelte-1f7z7gp"}">Son</option><option value="${"Daughter"}" class="${"svelte-1f7z7gp"}">Daughter</option><option value="${"Relative"}" class="${"svelte-1f7z7gp"}">Relative</option><option value="${"Friend"}" class="${"svelte-1f7z7gp"}">Friend</option></select>
        <p class="${"svelte-1f7z7gp"}">of the</p>
            <select defaultValue="${"Select Bride or Groom"}" class="${"form-element svelte-1f7z7gp"}" ${!isLoggedIn ? "disabled" : ""}${add_attribute("value", toast.toasterAssociation, 1)}><option selected disabled hidden value="${"Select Bride or Groom"}" class="${"svelte-1f7z7gp"}">Select Bride or Groom</option><option value="${"Groom"}" class="${"svelte-1f7z7gp"}">Groom</option><option value="${"Bride"}" class="${"svelte-1f7z7gp"}">Bride</option></select>
        <textarea class="${"form-element svelte-1f7z7gp"}" ${!isLoggedIn ? "disabled" : ""} rows="${"7"}" placeholder="${"Message"}">${toast.toastContent || ""}</textarea>
        ${!isLoggedIn
	? `<button class="${"facebook-button svelte-1f7z7gp"}">Log in with Facebook to Propose</button>`
	: ``}
        ${isLoggedIn
	? `${isEdittingToast
		? `<button class="${"propose-button svelte-1f7z7gp"}">Update!</button>`
		: `<button class="${"propose-button svelte-1f7z7gp"}">Propose!</button>`}`
	: ``}</div>
</section>`;
});
...
const ToastsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"toasts svelte-b1rabv"}">${each(toasts, toast => `<p>${escape(toast.toastContent)}</p>
		...
		? `<button class="${"svelte-b1rabv"}">Edit</button>
                <button class="${"svelte-b1rabv"}">Delete</button>
				...
				{
					default: () => `<div class="${"svelte-b1rabv"}">Are you sure you want to delete this toast?
                        <div class="${"svelte-b1rabv"}"><button class="${"svelte-b1rabv"}">Delete</button>
                            <button class="${"svelte-b1rabv"}">Cancel</button>
                        </div></div>
                `
				}
			)}`
...
const Menu = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${isOpen
	? `<div class="${"menu svelte-pr90y6"}"><ul class="${"svelte-pr90y6"}"><li class="${"home svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Home</div></li>
            <li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Our Story</div></li>
            <li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Our Clan</div></li>
            <li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Toasts</div></li>
            <li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Propose a Toast</div></li>
            <li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Blended Family</div></li>
        ${isLoggedIn
		? `<li class="${"svelte-pr90y6"}"><div class="${"arrow svelte-pr90y6"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-pr90y6"}"></div>
                <div class="${"section svelte-pr90y6"}">Log out</div></li>`
		: ``}</ul></div>`
	: ``}`;
});
...
const css$c = {
	code: "@media only screen and (min-width: 320px) and (max-width: 450px){.svelte-wq5t09{z-index:999}div.svelte-wq5t09{background-color:#375637;height:65px;width:100%;position:absolute;top:0}p.svelte-wq5t09{color:#ddd499;font-weight:bold;font-size:30px;line-height:30px;margin:17.5px 0 0 30px}}@media only screen and (min-width: 451px){.svelte-wq5t09{z-index:999}div.svelte-wq5t09{background-color:#375637;height:65px;width:calc(100% - 18px) !important;position:absolute;top:0}p.svelte-wq5t09{color:#ddd499;font-weight:bold;font-size:30px;line-height:30px;margin:17.5px 0 0 30px}}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import MenuIcon from './MenuIcon.svelte';\\r\\nimport Menu from './Menu.svelte';\\r\\nimport * as queryString from 'query-string';\\r\\nimport { createEventDispatcher } from 'svelte';\\r\\nconst dispatch = createEventDispatcher();\\r\\nexport let isLoggedIn;\\r\\nlet isOpen = false;\\r\\nfunction forward() {\\r\\n    dispatch('toggleLogIn');\\r\\n}\\r\\nfunction handleToggle() {\\r\\n    isOpen = !isOpen;\\r\\n}\\r\\n</script>\\r\\n\\r\\n<div>\\r\\n    <p>#blameitonfate</p>\\r\\n    <MenuIcon on:handleToggle={handleToggle} isOpen={isOpen}/>\\r\\n    <Menu on:handleToggle={handleToggle} isLoggedIn={isLoggedIn} on:toggleLogIn={forward} isOpen={isOpen}/>\\r\\n</div>\\r\\n\\r\\n<style lang='scss'>@media only screen and (min-width: 320px) and (max-width: 450px) {\\n  * {\\n    z-index: 999; }\\n  div {\\n    background-color: #375637;\\n    height: 65px;\\n    width: 100%;\\n    position: absolute;\\n    top: 0; }\\n  p {\\n    color: #ddd499;\\n    font-weight: bold;\\n    font-size: 30px;\\n    line-height: 30px;\\n    margin: 17.5px 0 0 30px; } }\\n\\n@media only screen and (min-width: 451px) {\\n  * {\\n    z-index: 999; }\\n  div {\\n    background-color: #375637;\\n    height: 65px;\\n    width: calc(100% - 18px) !important;\\n    position: absolute;\\n    top: 0; }\\n  p {\\n    color: #ddd499;\\n    font-weight: bold;\\n    font-size: 30px;\\n    line-height: 30px;\\n    margin: 17.5px 0 0 30px; } }</style>\"],\"names\":[],\"mappings\":\"AAqBmB,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACnF,cAAE,CAAC,AACD,OAAO,CAAE,GAAG,AAAE,CAAC,AACjB,GAAG,cAAC,CAAC,AACH,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,AAAE,CAAC,AACX,CAAC,cAAC,CAAC,AACD,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,MAAM,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,AAAE,CAAC,AAAC,CAAC,AAEhC,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzC,cAAE,CAAC,AACD,OAAO,CAAE,GAAG,AAAE,CAAC,AACjB,GAAG,cAAC,CAAC,AACH,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,UAAU,CACnC,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,AAAE,CAAC,AACX,CAAC,cAAC,CAAC,AACD,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,MAAM,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"svelte-wq5t09"}"><p class="${"svelte-wq5t09"}">#blameitonfate</p>

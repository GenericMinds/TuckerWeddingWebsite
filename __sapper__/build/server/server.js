...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<img src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-g0zj90"}">     
...
const css$7 = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';@import 'https://fonts.googleapis.com/css?family=Rokkitt';body{background-color:#fff9ea;margin:0;font-size:0;font-family:'Princess Sofia';overflow:auto;height:100%}h1{font-weight:100;text-align:center;font-size:40px;color:#ddd499;margin-bottom:0}div{overflow:hidden}section{text-align:center}section div{padding:20px}img{width:50%;margin-top:-20px}p{font-size:20px;font-family:'Rokkitt'}html{position:absolute;height:100%;overflow:hidden}",

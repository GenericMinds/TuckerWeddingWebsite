...
const css$1 = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';ul.svelte-8a97lc{position:fixed;top:40px;right:0;bottom:0;left:0;width:100%;height:100%;background:#375637;color:#ddd499;text-align:center;font-size:40px;overflow:hidden;padding:0;margin:0;list-style:none}li.svelte-8a97lc{height:15vh;padding-top:3vh}img.svelte-8a97lc{position:fixed;-webkit-backface-visibility:hidden;right:0;top:0;height:32px;width:32px;margin:0}img.svelte-8a97lc:hover,li.svelte-8a97lc:hover{cursor:pointer}",
...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<img src="${"./134216-32.png"}" alt="${"ji"}" class="${"svelte-8a97lc"}">
...
${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"ji"}" class="${"svelte-8a97lc"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-8a97lc"}"><li class="${"home svelte-8a97lc"}">Home</li>
        <li class="${"svelte-8a97lc"}">Our Story</li>
        <li class="${"svelte-8a97lc"}">Our Clan</li>
        <li class="${"svelte-8a97lc"}">Toasts</li>
        <li class="${"svelte-8a97lc"}">Propose a Toast</li>
        <li class="${"svelte-8a97lc"}">Blended Family</li></ul>`,
				default: () => `

	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			},
			{
				...
				content: () => `<ul slot="${"content"}" class="${"svelte-opwlpq"}"><li class="${"home svelte-opwlpq"}">Home</li>
        <li class="${"svelte-opwlpq"}">Our Story</li>
        <li class="${"svelte-opwlpq"}">Our Clan</li>
        <li class="${"svelte-opwlpq"}">Toasts</li>
        <li class="${"svelte-opwlpq"}">Propose a Toast</li>
        <li class="${"svelte-opwlpq"}">Blended Family</li></ul>`,
				default: () => `     

...
const css = {
	code: "@media only screen and (min-width: 1224px){div.svelte-15smyxw{background-color:#375637;height:75px;line-height:75px;padding:0}}",
	map: "{\"version\":3,\"file\":\"SectionHeader.svelte\",\"sources\":[\"SectionHeader.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import HeadingDecorator from './HeadingDecorator.svelte';\\r\\nexport let title;\\r\\n</script>\\r\\n\\r\\n<div>\\r\\n    <h1>{title}</h1>\\r\\n</div>\\r\\n<style lang='scss'>/* Smartphones (portrait and landscape) -------------------- */\\n/* --------------------------------------------------------- */\\n/* iPads (portrait and landscape) -------------------------- */\\n/* --------------------------------------------------------- */\\n/* Desktops and Laptops ------------------------------------ */\\n@media only screen and (min-width: 1224px) {\\n  div {\\n    background-color: #375637;\\n    height: 75px;\\n    line-height: 75px;\\n    padding: 0; } }\\n\\n/* --------------------------------------------------------- */\\n/* iPhone 4 ----------- */\\n/* --------------------------------------------------------- */</style>\"],\"names\":[],\"mappings\":\"AAYA,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,GAAG,eAAC,CAAC,AACH,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,IAAI,CACjB,OAAO,CAAE,CAAC,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const SectionHeader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"svelte-15smyxw"}"><h1>${escape(title)}</h1>
</div>`;
});
...
const Story = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div><p class="${"svelte-q31u02"}">Once upon a time there was a king and a viking princess. They did not know it, but the gods had set the table for them to be together.</p>
        <p class="${"svelte-q31u02"}">As the gods planned out their destiny, they couldn&#39;t quite agree on the path these two should take to get there. One of the gods set up their first meeting. As they were both looking to learn more about the world around them, they attended the Academy at the same time. The first god set it up so that they lived in close proximity. Once the other gods noticed, they intervened and kept them from meeting each other. It was not their time yet.</p>
        <p class="${"svelte-q31u02"}">Both the king and the viking princess went on to have families of their own. Another one of the gods thought that this was the time and moved them to the same town. Both of their families grew up at the same time. The king had two daughters and the viking princess had two sons and two daughters. The kids grew up with each other and became friends. The eldest viking son and the eldest princess of the king both pursued the bardic arts together. The youngest viking daughter and the youngest princess of the king battled for the raiders through volley after volley of balls flung by the invading armies. Through all of this the other gods decided it was not time for the king and the viking princess to meet, and kept them apart. It was not their time yet.</p>
        <p class="${"svelte-q31u02"}">A third god decided to make his move and arranged it so the viking princess joined the Parent Teacher Student Guild along with the Queen. Both were valiant champions in making sure the children of the kingdom were getting the appropriate education. Throughout their many meetings and public events, the other gods decided to intervene and not allow the king and viking princess to cross paths. It was not their time yet.</p>
        <p class="${"svelte-q31u02"}">The viking princess pursued her advancement in the Parent Teacher Student Guild with fervor and eventually reached the rank of Teacher of The Native Tongue. A fourth god decided this would be the perfect time to introduce the king and the viking princess. This god arranged for the king&#39;s youngest princess to become an apprentice of the viking princess. Alas, the other gods intervened yet again and did not let their paths cross. It was not their time yet.</p>
        <p class="${"svelte-q31u02"}">Living within the same kingdom, they were often in the market at the same time. Neither taking notice of each other. The gods had again decided to keep them away from each other. It was not their time yet.</p>
        <p class="${"svelte-q31u02"}">By this point in time, both had moved on from their previous relationships. While there were times where they were happy, they knew deep down that something was missing. Their sons and daughters had grown up and had families of their own. The gods finally decided it was time.</p>
        <p class="${"svelte-q31u02"}">One fateful day, they aligned the stars to allow them to meet. The king was discussing life with a noble friend of his in the market when the viking princess entered. Their paths would have crossed yet again without interaction, but the gods had carefully laid out this moment. The noble that the king was talking to happened to also be the brother in law of the eldest viking daughter. The noble noticed the viking princess and decided to make an introduction. After the noble left, they continued their shopping, glancing at each other through the market stalls. The strands of fate spinning stronger and stronger with each passing. Humans tend to be unpredictable and resist their destinies. The viking princess abruptly left the market without talking with the king further.</p>
        <p class="${"svelte-q31u02"}">The gods didn&#39;t like this. They filled her head with doubt and her heart with excitement. She knew she veered from their plans and decided to take her shot. She sent out messengers to find the king. They eventually tracked him down and arranged for them to meet again. A quick meeting at the tavern turned into a long conversations leading into the dead of night, yet somehow time felt like it was standing still. Everything was falling into place and the match felt like a perfect fit. But as a human himself, the king was stubborn and decided he wasn&#39;t ready for his destiny.</p>
...
const Clan = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"demo svelte-qpwu2j"}">${each(carousels, carousel => `${validate_component(Carousel, "Carousel").$$render($$result, Object.assign(carousel, { dots: false }), {}, {
		"left-control": () => `<span class="${"control svelte-qpwu2j"}" slot="${"left-control"}">${validate_component(ChevronLeftIcon, "ChevronLeftIcon").$$render($$result, {}, {}, {})}</span>`,
		"right-control": () => `<span class="${"control svelte-qpwu2j"}" slot="${"right-control"}">${validate_component(ChevronRightIcon, "ChevronRightIcon").$$render($$result, {}, {}, {})}
            </span>`,
		default: () => `
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/GrandchildrenWithBarb.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Cheese.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/MovingDay.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/FireAndIce.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithLiam.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Lake.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithNora.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/CarenaAndDog.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks2.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>				
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/RhiannahAndAdam.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SportsBar.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>		
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SummerAndClan.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/StPatricksDay.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndCarenaAndBri.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndClan.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/AustinAndClan.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>        
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Grandchildren.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ShannonAndClan.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithRhiannah.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/LisaAndAdam.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            <div class="${"slide-content svelte-qpwu2j"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/NanaAndPoppop.jpg)"}" class="${"svelte-qpwu2j"}"></header></div>
            `
	})}
        <br>
        <br>`)}</div>
...
const ToastForm = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"propose svelte-v278bn"}"><div class="${"form svelte-v278bn"}"><div class="${"header svelte-v278bn"}">${isEdittingToast
	? `<p class="${"heading svelte-v278bn"}">Editting Toast...</p>`
	: `<p class="${"heading svelte-v278bn"}">Propose a Toast...</p>`}</div>
        <input type="${"text"}" ${!isLoggedIn ? "disabled" : ""} placeholder="${"Name"}" class="${"svelte-v278bn"}"${add_attribute("value", toast.toasterName, 1)}>
        <div class="${"container svelte-v278bn"}"><div class="${"selectstuff svelte-v278bn"}"><select ${!isLoggedIn ? "disabled" : ""} class="${"svelte-v278bn"}"${add_attribute("value", toast.toasterRelationship, 1)}><option value="${"Father"}" selected>Father</option><option value="${"Mother"}">Mother</option><option value="${"Brother"}">Brother</option><option value="${"Sister"}">Sister</option><option value="${"Son"}">Son</option><option value="${"Daughter"}">Daughter</option><option value="${"Relative"}">Relative</option><option value="${"Friend"}">Friend</option></select></div>
        <div class="${"selectstuff svelte-v278bn"}">of the</div>
        <div class="${"selectstuff svelte-v278bn"}"><select ${!isLoggedIn ? "disabled" : ""} class="${"svelte-v278bn"}"${add_attribute("value", toast.toasterAssociation, 1)}><option value="${"Groom"}" selected>Groom</option><option value="${"Bride"}">Bride</option></select></div></div>
        <textarea ${!isLoggedIn ? "disabled" : ""} rows="${"7"}" placeholder="${"Message"}" class="${"svelte-v278bn"}">${toast.toastContent || ""}</textarea>
        <br>
        ${!isLoggedIn
	? `<button class="${"facebook-button svelte-v278bn"}">Log in with Facebook to Propose</button>`
	: ``}
        ${isLoggedIn
	? `${isEdittingToast
		? `<button class="${"propose-button svelte-v278bn"}">Update!</button>`
		: `<button class="${"propose-button svelte-v278bn"}">Propose!</button>`}`
	: ``}</div>
</section>`;
});
...
const ToastsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<section class="${"toasts"}"><h1>Toasts</h1>
    <img alt="${"Heading Decoration"}" src="${"./HeadingDecorator.png"}">
    <div>${each(toasts, toast => `<p>${escape(toast.toastContent)}</p>
		...
		? `<button class="${"svelte-1xa85dm"}">Edit</button>
...
const css$c = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';@media only screen and (min-width: 1224px){img.svelte-12xyj2v{position:fixed;right:30px;top:15px;height:45px;width:45px;margin:0}img.svelte-12xyj2v:hover{cursor:pointer}}",
...
const Menu = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${isOpen
	? `<div class="${"menu svelte-hv3bhp"}"><ul class="${"svelte-hv3bhp"}"><li class="${"home svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Home</div></li>
            <li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Our Story</div></li>
            <li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Our Clan</div></li>
            <li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Toasts</div></li>
            <li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Propose a Toast</div></li>
            <li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Blended Family</div></li>
        ${isLoggedIn
		? `<li class="${"svelte-hv3bhp"}"><div class="${"arrow svelte-hv3bhp"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-hv3bhp"}"></div>
                <div class="${"section svelte-hv3bhp"}">Log out</div></li>`
		: ``}</ul></div>`
	: ``}`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"svelte-2xcyfd"}"><p class="${"svelte-2xcyfd"}">#blameitonfate</p>

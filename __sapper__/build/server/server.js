...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<svg slot="${"parent"}" x="${"0px"}" y="${"0px"}" viewBox="${"0 0 50 50"}" enable-background="${"new 0 0 50 50"}" xml:space="${"preserve"}" height="${"40px"}" width="${"40px"}" class="${"svelte-1rgt2b5"}"><path fill="${"#ddd499"}" d="${"M8.667,15h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,15,8.667,15z"}"></path><path fill="${"#ddd499"}" d="${"M8.667,37h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,37,8.667,37z"}"></path><path fill="${"#ddd499"}" d="${"M8.667,26h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,26,8.667,26z"}"></path></svg>`,
				content: () => `<ul slot="${"content"}" class="${"svelte-1rgt2b5"}"><li class="${"home svelte-1rgt2b5"}">Home</li>
        <li class="${"svelte-1rgt2b5"}">Our Story</li>
        <li class="${"svelte-1rgt2b5"}">Our Clan</li>
        <li class="${"svelte-1rgt2b5"}">Toasts</li>
        <li class="${"svelte-1rgt2b5"}">Propose a Toast</li>
        <li class="${"svelte-1rgt2b5"}">Blended Family</li></ul>`,
				default: () => `     

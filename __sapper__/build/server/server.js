...
const Clan = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <img alt="${"Heading Decoration"}" class="${"headingDecorator svelte-pm0vw8"}" src="${"./HeadingDecorator.png"}"></section>
<div class="${"demo svelte-pm0vw8"}">${each(carousels, carousel => `${validate_component(Carousel, "Carousel").$$render($$result, Object.assign(carousel), {}, {
		"left-control": () => `<span class="${"control svelte-pm0vw8"}" slot="${"left-control"}">${validate_component(ChevronLeftIcon, "ChevronLeftIcon").$$render($$result, {}, {}, {})}</span>`,
		"right-control": () => `<span class="${"control svelte-pm0vw8"}" slot="${"right-control"}">${validate_component(ChevronRightIcon, "ChevronRightIcon").$$render($$result, {}, {}, {})}
        </span>`,
		default: () => `
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/GrandchildrenWithBarb.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Cheese.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/MovingDay.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/FireAndIce.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithLiam.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Lake.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithNora.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/CarenaAndDog.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks2.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>				
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/RhiannahAndAdam.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SportsBar.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>		
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SummerAndClan.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/StPatricksDay.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndCarenaAndBri.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndClan.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/AustinAndClan.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>        
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Grandchildren.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ShannonAndClan.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithRhiannah.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/LisaAndAdam.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        <div class="${"slide-content svelte-pm0vw8"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/NanaAndPoppop.jpg)"}" class="${"svelte-pm0vw8"}"></header></div>
        `
	})}
    <br>
    <br>`)}

...
/******/ 		return __webpack_require__.p + "" + "0445cc61cc19af072e5f" + "/" + ({"vendors~index":"vendors~index","index":"index"}[chunkId]||chunkId) + "." + chunkId + ".js"
/******/ 	}
/******/
...
const ignore = [/^\/api\/toastController\.json$/, /^\/api\/facebookController\/?$/, /^\/api\/awsController\/?$/];

...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"ji"}" class="${"svelte-1n65y70"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-1n65y70"}"><li class="${"home svelte-1n65y70"}">Home</li>
        <li class="${"svelte-1n65y70"}">Our Story</li>
        <li class="${"svelte-1n65y70"}">Our Clan</li>
        <li class="${"svelte-1n65y70"}">Toasts</li>
        <li class="${"svelte-1n65y70"}">Propose a Toast</li>
        <li class="${"svelte-1n65y70"}">Blended Family</li></ul>`,
				default: () => `

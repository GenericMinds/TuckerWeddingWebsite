...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
        ...
        <li class="${"svelte-13v90wq"}">Propose a Toast</li>
        <li class="${"svelte-13v90wq"}">Blended Family Recipe</li></ul>`,
				default: () => `

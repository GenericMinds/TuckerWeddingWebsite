...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-mv8qu"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-mv8qu"}"><li class="${"home svelte-mv8qu"}">Home</li>
        <li class="${"svelte-mv8qu"}">Our Story</li>
        <li class="${"svelte-mv8qu"}">Our Clan</li>
        <li class="${"svelte-mv8qu"}">Toasts</li>
        <li class="${"svelte-mv8qu"}">Propose a Toast</li>
        <li class="${"svelte-mv8qu"}">Blended Family</li></ul>`,
				default: () => `

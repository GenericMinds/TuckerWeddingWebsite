...
const css = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';div.svelte-vxy7xr,ul.svelte-vxy7xr{position:absolute !important;top:40px;right:0;bottom:0;left:0;width:100vw;height:100vh;background-color:#375637;color:#ddd499;text-align:center;font-size:40px;overflow:hidden;padding:0;margin:0;list-style:none;z-index:999}li.svelte-vxy7xr{height:10vh;padding-top:3vh}img.svelte-vxy7xr{position:fixed;right:0;top:0;height:32px;width:32px;z-index:999;-webkit-backface-visibility:hidden;margin:0}img.svelte-vxy7xr:hover,li.svelte-vxy7xr:hover{cursor:pointer}div.svelte-vxy7xr{position:relative;width:100%;height:100%}",
	map: "{\"version\":3,\"file\":\"MenuIcon.svelte\",\"sources\":[\"MenuIcon.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import Overlay from 'svelte-overlay';\\r\\nimport * as animateScroll from 'svelte-scrollto';\\r\\nlet isOpen = false;\\r\\nfunction handleToggle() {\\r\\n    isOpen = !isOpen;\\r\\n}\\r\\nfunction handleSectionSelection(section) {\\r\\n    isOpen = false;\\r\\n    if (section == 'home') {\\r\\n        animateScroll.scrollToTop();\\r\\n        return;\\r\\n    }\\r\\n    animateScroll.scrollTo({ element: '.' + section });\\r\\n}\\r\\n</script>\\r\\n<img on:click={handleToggle} src='./134216-32.png' alt='hamburger menu'/>     \\r\\n\\r\\n{#if isOpen}\\r\\n    <div>\\r\\n        <ul>\\r\\n            <li class='home' on:click={() => {handleSectionSelection('home')}}>Home</li>\\r\\n            <li on:click={() => {handleSectionSelection('story')}}>Our Story</li>\\r\\n            <li on:click={() => {handleSectionSelection('clan')}}>Our Clan</li>\\r\\n            <li on:click={() => {handleSectionSelection('toasts')}}>Toasts</li>\\r\\n            <li on:click={() => {handleSectionSelection('propose')}}>Propose a Toast</li>\\r\\n            <li on:click={() => {handleSectionSelection('blended')}}>Blended Family</li>\\r\\n        </ul>\\r\\n    </div>\\r\\n{/if}\\r\\n\\r\\n<style lang='scss'>@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';\\ndiv, ul {\\n  position: absolute !important;\\n  top: 40px;\\n  right: 0;\\n  bottom: 0;\\n  left: 0;\\n  width: 100vw;\\n  height: 100vh;\\n  background-color: #375637;\\n  color: #ddd499;\\n  text-align: center;\\n  font-size: 40px;\\n  overflow: hidden;\\n  padding: 0;\\n  margin: 0;\\n  list-style: none;\\n  z-index: 999; }\\n\\nli {\\n  height: 10vh;\\n  padding-top: 3vh; }\\n\\nimg {\\n  position: fixed;\\n  right: 0;\\n  top: 0;\\n  height: 32px;\\n  width: 32px;\\n  z-index: 999;\\n  -webkit-backface-visibility: hidden;\\n  margin: 0; }\\n\\nimg:hover, li:hover {\\n  cursor: pointer; }\\n\\ndiv {\\n  position: relative;\\n  width: 100%;\\n  height: 100%; }</style>\"],\"names\":[],\"mappings\":\"AA8BmB,QAAQ,wDAAwD,CAAC,AACpF,iBAAG,CAAE,EAAE,cAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAAC,UAAU,CAC7B,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,AAAE,CAAC,AAEjB,EAAE,cAAC,CAAC,AACF,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,GAAG,AAAE,CAAC,AAErB,GAAG,cAAC,CAAC,AACH,QAAQ,CAAE,KAAK,CACf,KAAK,CAAE,CAAC,CACR,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CACZ,2BAA2B,CAAE,MAAM,CACnC,MAAM,CAAE,CAAC,AAAE,CAAC,AAEd,iBAAG,MAAM,CAAE,gBAAE,MAAM,AAAC,CAAC,AACnB,MAAM,CAAE,OAAO,AAAE,CAAC,AAEpB,GAAG,cAAC,CAAC,AACH,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAAE,CAAC\"}"
};
...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<img src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-vxy7xr"}">     

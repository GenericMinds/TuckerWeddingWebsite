...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-1a1o496"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-1a1o496"}"><li class="${"home svelte-1a1o496"}">Home</li>
        <li class="${"svelte-1a1o496"}">Our Story</li>
        <li class="${"svelte-1a1o496"}">Our Clan</li>
        <li class="${"svelte-1a1o496"}">Toasts</li>
        <li class="${"svelte-1a1o496"}">Propose a Toast</li>
        <li class="${"svelte-1a1o496"}">Blended Family</li></ul>`,
				default: () => `     

...
const css$a = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';@media only screen and (min-width: 1025px){img.svelte-1bo4uxf{position:fixed;right:30px;top:17.5px;height:30px;width:30px;margin:0}img.svelte-1bo4uxf:hover{cursor:pointer}}",
	map: "{\"version\":3,\"file\":\"MenuIcon.svelte\",\"sources\":[\"MenuIcon.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import { createEventDispatcher } from 'svelte';\\r\\nconst dispatch = createEventDispatcher();\\r\\nlet isOpen = false;\\r\\nfunction handleToggle() {\\r\\n    dispatch('handleToggle');\\r\\n}\\r\\n</script>\\r\\n\\r\\n<img on:click={handleToggle} src='./134216-32.png' alt='hamburger menu'/>     \\r\\n\\r\\n<style lang='scss'>@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';\\n/* Smartphones (portrait and landscape) -------------------- */\\n/* --------------------------------------------------------- */\\n/* iPads (portrait and landscape) -------------------------- */\\n/* --------------------------------------------------------- */\\n/* Desktops and Laptops ------------------------------------ */\\n@media only screen and (min-width: 1025px) {\\n  img {\\n    position: fixed;\\n    right: 30px;\\n    top: 17.5px;\\n    height: 30px;\\n    width: 30px;\\n    margin: 0; }\\n  img:hover {\\n    cursor: pointer; } }\\n\\n/* --------------------------------------------------------- */\\n/* iPhone 4 ----------- */\\n/* --------------------------------------------------------- */</style>\"],\"names\":[],\"mappings\":\"AAUmB,QAAQ,wDAAwD,CAAC,AAMpF,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,GAAG,eAAC,CAAC,AACH,QAAQ,CAAE,KAAK,CACf,KAAK,CAAE,IAAI,CACX,GAAG,CAAE,MAAM,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,AAAE,CAAC,AACd,kBAAG,MAAM,AAAC,CAAC,AACT,MAAM,CAAE,OAAO,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<img src="${"./134216-32.png"}" alt="${"hamburger menu"}" class="${"svelte-1bo4uxf"}">`;
});

/* src\routes\_components\Menu.svelte generated by Svelte v3.23.2 */

const css$b = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';@media only screen and (min-width: 1025px){.menu.svelte-1fmij5r.svelte-1fmij5r{position:absolute;top:65px;right:0;width:25%;height:100vh;background-color:#375637;color:#ddd499;z-index:999}ul.svelte-1fmij5r.svelte-1fmij5r{text-align:center;font-size:35px;overflow:hidden;padding:0;margin:0;list-style:none;height:100%}li.svelte-1fmij5r.svelte-1fmij5r:hover{background-color:#2E4A2E}li.svelte-1fmij5r:hover div.svelte-1fmij5r{text-decoration:underline;cursor:pointer}li.svelte-1fmij5r.svelte-1fmij5r{height:10%}div.svelte-1fmij5r.svelte-1fmij5r{display:block;height:100%;text-align:center;font-size:32px;line-height:32px}.arrow.svelte-1fmij5r.svelte-1fmij5r{float:left;width:6.25%}img.svelte-1fmij5r.svelte-1fmij5r{width:100%}.section.svelte-1fmij5r.svelte-1fmij5r{width:93.75%;float:right}}",
	map: "{\"version\":3,\"file\":\"Menu.svelte\",\"sources\":[\"Menu.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import Overlay from 'svelte-overlay';\\r\\nimport * as animateScroll from 'svelte-scrollto';\\r\\nimport { createEventDispatcher } from 'svelte';\\r\\nconst dispatch = createEventDispatcher();\\r\\nexport let isLoggedIn;\\r\\nexport let isOpen;\\r\\nfunction logOut() {\\r\\n    dispatch(\\\"toggleLogIn\\\");\\r\\n    handleSectionSelection('home');\\r\\n}\\r\\nfunction handleSectionSelection(section) {\\r\\n    isOpen = false;\\r\\n    if (section == 'home') {\\r\\n        animateScroll.scrollToTop();\\r\\n        return;\\r\\n    }\\r\\n    animateScroll.scrollTo({ element: '.' + section, offset: -62.5 });\\r\\n}\\r\\n</script>\\r\\n\\r\\n{#if isOpen}\\r\\n    <div class='menu'>\\r\\n        <ul>\\r\\n            <li class='home' on:click={() => {handleSectionSelection('home')}}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Home</div>\\r\\n            </li>\\r\\n            <li on:click={() => {handleSectionSelection('story')}}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Our Story</div>\\r\\n            </li>\\r\\n            <li on:click={() => {handleSectionSelection('clan')}}>                \\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Our Clan</div>\\r\\n            </li>\\r\\n            <li on:click={() => {handleSectionSelection('toasts')}}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Toasts</div>\\r\\n            </li>\\r\\n            <li on:click={() => {handleSectionSelection('propose')}}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Propose a Toast</div>\\r\\n            </li>\\r\\n            <li on:click={() => {handleSectionSelection('blended')}}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Blended Family</div>\\r\\n            </li>\\r\\n        {#if isLoggedIn}\\r\\n            <li on:click={logOut}>\\r\\n                <div class='arrow'>\\r\\n                    <img src='./icons8-collapse-arrow-50.png' alt='arrow'/>\\r\\n                </div>\\r\\n                <div class='section'>Log out</div>\\r\\n            </li>\\r\\n        {/if}\\r\\n        </ul>\\r\\n    </div>\\r\\n{/if}\\r\\n\\r\\n<style lang='scss'>@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';\\n/* Smartphones (portrait and landscape) -------------------- */\\n/* --------------------------------------------------------- */\\n/* iPads (portrait and landscape) -------------------------- */\\n/* --------------------------------------------------------- */\\n/* Desktops and Laptops ------------------------------------ */\\n@media only screen and (min-width: 1025px) {\\n  .menu {\\n    position: absolute;\\n    top: 65px;\\n    right: 0;\\n    width: 25%;\\n    height: 100vh;\\n    background-color: #375637;\\n    color: #ddd499;\\n    z-index: 999; }\\n  ul {\\n    text-align: center;\\n    font-size: 35px;\\n    overflow: hidden;\\n    padding: 0;\\n    margin: 0;\\n    list-style: none;\\n    height: 100%; }\\n  li:hover {\\n    background-color: #2E4A2E; }\\n    li:hover div {\\n      text-decoration: underline;\\n      cursor: pointer; }\\n  li {\\n    height: 10%; }\\n  div {\\n    display: block;\\n    height: 100%;\\n    text-align: center;\\n    font-size: 32px;\\n    line-height: 32px; }\\n  .arrow {\\n    float: left;\\n    width: 6.25%; }\\n  img {\\n    width: 100%; }\\n  .section {\\n    width: 93.75%;\\n    float: right; } }\\n\\n/* --------------------------------------------------------- */\\n/* iPhone 4 ----------- */\\n/* --------------------------------------------------------- */</style>\"],\"names\":[],\"mappings\":\"AAuEmB,QAAQ,wDAAwD,CAAC,AAMpF,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,KAAK,8BAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,CAAC,CACR,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,KAAK,CACb,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,CACd,OAAO,CAAE,GAAG,AAAE,CAAC,AACjB,EAAE,8BAAC,CAAC,AACF,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,IAAI,AAAE,CAAC,AACjB,gCAAE,MAAM,AAAC,CAAC,AACR,gBAAgB,CAAE,OAAO,AAAE,CAAC,AAC5B,iBAAE,MAAM,CAAC,GAAG,eAAC,CAAC,AACZ,eAAe,CAAE,SAAS,CAC1B,MAAM,CAAE,OAAO,AAAE,CAAC,AACtB,EAAE,8BAAC,CAAC,AACF,MAAM,CAAE,GAAG,AAAE,CAAC,AAChB,GAAG,8BAAC,CAAC,AACH,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,AAAE,CAAC,AACtB,MAAM,8BAAC,CAAC,AACN,KAAK,CAAE,IAAI,CACX,KAAK,CAAE,KAAK,AAAE,CAAC,AACjB,GAAG,8BAAC,CAAC,AACH,KAAK,CAAE,IAAI,AAAE,CAAC,AAChB,QAAQ,8BAAC,CAAC,AACR,KAAK,CAAE,MAAM,CACb,KAAK,CAAE,KAAK,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const Menu = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${isOpen
	? `<div class="${"menu svelte-1fmij5r"}"><ul class="${"svelte-1fmij5r"}"><li class="${"home svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Home</div></li>
            <li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Our Story</div></li>
            <li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Our Clan</div></li>
            <li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Toasts</div></li>
            <li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Propose a Toast</div></li>
            <li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Blended Family</div></li>
        ${isLoggedIn
		? `<li class="${"svelte-1fmij5r"}"><div class="${"arrow svelte-1fmij5r"}"><img src="${"./icons8-collapse-arrow-50.png"}" alt="${"arrow"}" class="${"svelte-1fmij5r"}"></div>
                <div class="${"section svelte-1fmij5r"}">Log out</div></li>`
		: ``}</ul></div>`
	: ``}`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"svelte-1vstr9v"}"><p class="${"svelte-1vstr9v"}">#blameitonfate</p>

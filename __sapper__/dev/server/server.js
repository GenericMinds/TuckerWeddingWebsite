...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<img src="${"./134216-32.png"}" alt="${"ji"}" class="${"svelte-6wppzb"}">
...
${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<img slot="${"parent"}" src="${"./134216-32.png"}" alt="${"ji"}" class="${"svelte-6wppzb"}">`,
				content: () => `<ul slot="${"content"}" class="${"svelte-6wppzb"}"><li class="${"home svelte-6wppzb"}">Home</li>
        <li class="${"svelte-6wppzb"}">Our Story</li>
        <li class="${"svelte-6wppzb"}">Our Clan</li>
        <li class="${"svelte-6wppzb"}">Toasts</li>
        <li class="${"svelte-6wppzb"}">Propose a Toast</li>
        <li class="${"svelte-6wppzb"}">Blended Family</li></ul>`,
				default: () => `

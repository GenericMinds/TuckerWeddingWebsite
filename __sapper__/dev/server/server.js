...
const Clan = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"wrapper svelte-1cm5419"}"><div class="${"demo svelte-1cm5419"}">${each(carousels, carousel => `${validate_component(Carousel, "Carousel").$$render($$result, Object.assign(carousel), {}, {
		"left-control": () => `<span class="${"control svelte-1cm5419"}" slot="${"left-control"}">${validate_component(ChevronLeftIcon, "ChevronLeftIcon").$$render($$result, {}, {}, {})}</span>`,
		"right-control": () => `<span class="${"control svelte-1cm5419"}" slot="${"right-control"}">${validate_component(ChevronRightIcon, "ChevronRightIcon").$$render($$result, {}, {}, {})}
            </span>`,
		default: () => `
            ${each(photos, photo => `<div class="${"slide-content svelte-1cm5419"}"><img${add_attribute("src", photo, 0)} alt="${"pic"}" class="${"svelte-1cm5419"}">
            </div>`)}
            `
	})}
        <br>
...
const css$f = {
	code: "@media only screen and (min-width: 1224px){div.svelte-re6cqn{background-color:#375637;height:65px;width:100%;position:absolute;top:0;grid-column:1/4;grid-column-start:1;grid-column-end:4;grid-row-start:1;grid-row-end:3;display:grid;grid-template-columns:repeat(3, 1fr)}p.svelte-re6cqn{color:#ddd499;font-weight:bold;font-size:30px;line-height:30px;margin:17.5px 0 0 30px}}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script lang='typescript'>import MenuIcon from './MenuIcon.svelte';\\r\\nimport Menu from './Menu.svelte';\\r\\nimport * as queryString from 'query-string';\\r\\nimport { createEventDispatcher } from 'svelte';\\r\\nconst dispatch = createEventDispatcher();\\r\\nexport let isLoggedIn;\\r\\nlet isOpen = false;\\r\\nfunction forward() {\\r\\n    dispatch('toggleLogIn');\\r\\n}\\r\\nfunction handleToggle() {\\r\\n    isOpen = !isOpen;\\r\\n}\\r\\n</script>\\r\\n\\r\\n<div>\\r\\n    <p>#blameitonfate</p>\\r\\n    <MenuIcon on:handleToggle={handleToggle} isOpen={isOpen}/>\\r\\n    <Menu isLoggedIn={isLoggedIn} on:toggleLogIn={forward} isOpen={isOpen}/>\\r\\n</div>\\r\\n\\r\\n<style lang='scss'>/* Smartphones (portrait and landscape) -------------------- */\\n/* --------------------------------------------------------- */\\n/* iPads (portrait and landscape) -------------------------- */\\n/* --------------------------------------------------------- */\\n/* Desktops and Laptops ------------------------------------ */\\n@media only screen and (min-width: 1224px) {\\n  div {\\n    background-color: #375637;\\n    height: 65px;\\n    width: 100%;\\n    position: absolute;\\n    top: 0;\\n    grid-column: 1/4;\\n    grid-column-start: 1;\\n    grid-column-end: 4;\\n    grid-row-start: 1;\\n    grid-row-end: 3;\\n    display: grid;\\n    grid-template-columns: repeat(3, 1fr); }\\n  p {\\n    color: #ddd499;\\n    font-weight: bold;\\n    font-size: 30px;\\n    line-height: 30px;\\n    margin: 17.5px 0 0 30px; } }\\n\\n/* --------------------------------------------------------- */\\n/* iPhone 4 ----------- */\\n/* --------------------------------------------------------- */</style>\"],\"names\":[],\"mappings\":\"AA0BA,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,AAAC,CAAC,AAC1C,GAAG,cAAC,CAAC,AACH,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,WAAW,CAAE,CAAC,CAAC,CAAC,CAChB,iBAAiB,CAAE,CAAC,CACpB,eAAe,CAAE,CAAC,CAClB,cAAc,CAAE,CAAC,CACjB,YAAY,CAAE,CAAC,CACf,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,CAAC,CAAC,CAAC,GAAG,CAAC,AAAE,CAAC,AAC1C,CAAC,cAAC,CAAC,AACD,KAAK,CAAE,OAAO,CACd,WAAW,CAAE,IAAI,CACjB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,MAAM,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,AAAE,CAAC,AAAC,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"svelte-re6cqn"}"><p class="${"svelte-re6cqn"}">#blameitonfate</p>

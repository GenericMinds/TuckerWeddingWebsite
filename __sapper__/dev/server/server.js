...
${validate_component(Overlay, "Overlay").$$render(
        ...
        <li class="${"svelte-1jaf61n"}">Our Clan</li>
...
const Clan = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <img alt="${"Heading Decoration"}" class="${"headingDecorator svelte-1qx1zda"}" src="${"./HeadingDecorator.png"}"></section>
<div class="${"demo svelte-1qx1zda"}">${each(carousels, carousel => `${validate_component(Carousel, "Carousel").$$render($$result, Object.assign(carousel), {}, {
		"left-control": () => `<span class="${"control svelte-1qx1zda"}" slot="${"left-control"}">${validate_component(ChevronLeftIcon, "ChevronLeftIcon").$$render($$result, {}, {}, {})}</span>`,
		"right-control": () => `<span class="${"control svelte-1qx1zda"}" slot="${"right-control"}">${validate_component(ChevronRightIcon, "ChevronRightIcon").$$render($$result, {}, {}, {})}
        </span>`,
		default: () => `
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/GrandchildrenWithBarb.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Cheese.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/MovingDay.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/FireAndIce.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithLiam.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Lake.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithNora.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/CarenaAndDog.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Masks2.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>				
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/RhiannahAndAdam.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SportsBar.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>		
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/SummerAndClan.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/StPatricksDay.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndCarenaAndBri.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ToryAndClan.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/AustinAndClan.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>        
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/Grandchildren.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/ShannonAndClan.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/WithRhiannah.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/LisaAndAdam.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        <div class="${"slide-content svelte-1qx1zda"}"><header style="${"background-image: url(https://lisaandtimpictures.s3.amazonaws.com/NanaAndPoppop.jpg)"}" class="${"svelte-1qx1zda"}"></header></div>
        `
	})}
    <br>
    <br>`)}
...
const css$7 = {
	code: "section.svelte-z9odf3{height:65vh;width:100%;margin-bottom:40px}div.svelte-z9odf3{padding:0}.form.svelte-z9odf3{background-color:#ded599;height:100%;margin:20px;border-radius:20px}.header.svelte-z9odf3{border-radius:20px 20px 0 0;height:75px;background-color:#375637;position:relative}.heading.svelte-z9odf3{font-size:32px;margin:0;position:absolute;top:50%;transform:translate(0, -50%);padding-left:10px;color:#ddd499}input.svelte-z9odf3,textarea.svelte-z9odf3{width:80%;padding-left:10px;padding-right:10px;line-height:40px;font-size:20px}input.svelte-z9odf3{margin-top:25px}textarea.svelte-z9odf3{margin-bottom:25px}.selectstuff.svelte-z9odf3{display:table-cell;line-height:40px;font-size:20px}.container.svelte-z9odf3{display:table;width:100%;table-layout:fixed}",
...
const ProposeToastForm = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"propose svelte-z9odf3"}"><div class="${"form svelte-z9odf3"}"><div class="${"header svelte-z9odf3"}"><p class="${"heading svelte-z9odf3"}">Propose a Toast...</p></div>
        <input type="${"text"}" placeholder="${"Name"}" class="${"svelte-z9odf3"}"${add_attribute("value", toast.toasterName, 1)}>
        <div class="${"container svelte-z9odf3"}"><div class="${"selectstuff svelte-z9odf3"}"><select${add_attribute("value", toast.toasterRelationship, 1)}><option value="${"Father"}" selected>Father</option><option value="${"Mother"}">Mother</option><option value="${"Brother"}">Brother</option><option value="${"Sister"}">Sister</option><option value="${"Son"}">Son</option><option value="${"Daughter"}">Daughter</option><option value="${"Relative"}">Relative</option><option value="${"Friend"}">Friend</option></select></div>
        <div class="${"selectstuff svelte-z9odf3"}">of the</div>
        <div class="${"selectstuff svelte-z9odf3"}"><select${add_attribute("value", toast.toasterAssociation, 1)}><option value="${"Groom"}" selected>Groom</option><option value="${"Bride"}">Bride</option></select></div></div>
        <textarea rows="${"7"}" placeholder="${"Message"}" class="${"svelte-z9odf3"}">${toast.toastContent || ""}</textarea>
        <br>

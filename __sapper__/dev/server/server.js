...
const Story = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section>${validate_component(SectionHeader, "SectionHeader").$$render($$result, { isNav: false }, {}, {})}
    <h1>Our Story</h1>
    <img alt="${"Heading Decoration"}" src="${"./divider-36080.png"}">
...
const css$5 = {
	...
	map: "{\"version\":3,\"file\":\"Family.svelte\",\"sources\":[\"Family.svelte\"],\"sourcesContent\":[\"<section>\\r\\n    <h1>Our Family</h1>\\r\\n    <img alt='Heading Decoration' src='./divider-36080.png'/>\\r\\n</section>\\r\\n\\r\\n<style lang='scss'>img {\\n  width: 50%;\\n  margin-top: -20px; }</style>\\r\\n\"],\"names\":[],\"mappings\":\"AAKmB,GAAG,cAAC,CAAC,AACtB,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,KAAK,AAAE,CAAC\"}"
};

const Family = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$5);

	return `<section><h1>Our Family</h1>
    <img alt="${"Heading Decoration"}" src="${"./divider-36080.png"}" class="${"svelte-ij2qc1"}">
</section>`;
});

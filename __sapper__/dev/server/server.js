...
const MenuIcon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `${isOpen
		? `<div class="${"backdrop svelte-xz1b2l"}"></div>`
		: ``}
...
${validate_component(Overlay, "Overlay").$$render(
			...
			{
				parent: () => `<svg slot="${"parent"}" class="${"parent svelte-xz1b2l"}" x="${"0px"}" y="${"0px"}" viewBox="${"0 0 50 50"}" enable-background="${"new 0 0 50 50"}" xml:space="${"preserve"}" height="${"40px"}" width="${"40px"}"><path fill="${"#ddd499"}" d="${"M8.667,15h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,15,8.667,15z"}"></path><path fill="${"#ddd499"}" d="${"M8.667,37h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,37,8.667,37z"}"></path><path fill="${"#ddd499"}" d="${"M8.667,26h30c0.552,0,1-0.447,1-1s-0.448-1-1-1h-30c-0.552,0-1,0.447-1,1S8.114,26,8.667,26z"}"></path></svg>`,
				content: () => `<ul slot="${"content"}" class="${"content svelte-xz1b2l"}"><li class="${"home svelte-xz1b2l"}">Home</li>
        <li class="${"svelte-xz1b2l"}">Our Story</li>
        <li class="${"svelte-xz1b2l"}">Our Family</li>
        <li class="${"svelte-xz1b2l"}">Remembering the Day</li>
        <li class="${"svelte-xz1b2l"}">Propose a Toast</li></ul>`,
				default: () => `
...
const css$6 = {
	code: "@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';body{background-color:#fff9ea;margin:0;font-size:0}h1{font-family:'Princess Sofia';font-weight:100;text-align:center;font-size:42px;color:#375637}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\r\\n    import SectionHeader from './_components/SectionHeader.svelte';\\r\\n    import Jumbotron from './_components/Jumbotron.svelte';\\r\\n    import Story from './_components/Story.svelte';\\r\\n    import Family from './_components/Family.svelte';\\r\\n    import Toasts from './_components/Toasts.svelte';\\r\\n    import ProposeToastForm from './_components/ProposeToastForm.svelte';\\r\\n</script>\\r\\n\\r\\n<SectionHeader isNav={true} />\\r\\n<Jumbotron />\\r\\n<Story />\\r\\n<Family />\\r\\n<Toasts />\\r\\n<ProposeToastForm/>\\r\\n\\r\\n<style lang=\\\"scss\\\">@import 'https://fonts.googleapis.com/css?family=Princess+Sofia';\\n:global(body) {\\n  background-color: #fff9ea;\\n  margin: 0;\\n  font-size: 0; }\\n\\n:global(h1) {\\n  font-family: 'Princess Sofia';\\n  font-weight: 100;\\n  text-align: center;\\n  font-size: 42px;\\n  color: #375637; }</style>\"],\"names\":[],\"mappings\":\"AAgBmB,QAAQ,wDAAwD,CAAC,AAC5E,IAAI,AAAE,CAAC,AACb,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,CAAC,CACT,SAAS,CAAE,CAAC,AAAE,CAAC,AAET,EAAE,AAAE,CAAC,AACX,WAAW,CAAE,gBAAgB,CAC7B,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,AAAE,CAAC\"}"
};
